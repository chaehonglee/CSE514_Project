...
Reduces the total number of convolutional and deconvolutional blocks
...
def generate_u_net_v2(num_classes = 21, input_size = (512, 512, 3),\
    ...
    conv_c21 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c22 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e11 = Conv2D(filters=1024, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=dilation_rate**3)(pool_2)
    ...
    #copy conv_c22 to up_1
    cat_1 = concatenate([conv_c22, up_1])

    conv_e41 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(cat_1)
    conv_e41 = BatchNormalization()(conv_e41)
    conv_e42 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(conv_e41)
    conv_e42 = BatchNormalization()(conv_e42)
    up_2 = UpSampling2D(size=(2,2))(conv_e42)
    
    #copy conv_c12 to up_4
    cat_2 = concatenate([conv_c12, up_2])
