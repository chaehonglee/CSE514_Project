...
def generate_u_net_v3(num_classes = 21, input_size = (512, 512, 3),\
    ...
    conv_c11 = Conv2D(filters=32, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c12 = Conv2D(filters=32, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c21 = Conv2D(filters=64, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c22 = Conv2D(filters=64, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c31 = Conv2D(filters=128, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c32 = Conv2D(filters=128, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c41 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_c42 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e11 = Conv2D(filters=512, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e12 = Conv2D(filters=512, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e21 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(cat_1)
    conv_e21 = BatchNormalization()(conv_e21)
    conv_e22 = Conv2D(filters=256, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e31 = Conv2D(filters=128, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(cat_2)
    conv_e31 = BatchNormalization()(conv_e31)
    conv_e32 = Conv2D(filters=128, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_e41 = Conv2D(filters=64, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(cat_3)
    conv_e41 = BatchNormalization()(conv_e41)
    conv_e42 = Conv2D(filters=64, kernel_size=(3,3), strides=(1,1),\
    ...
    conv_o1 = Conv2D(filters=32, kernel_size=(3,3), strides=(1,1),\
                     activation='relu', padding='same', kernel_initializer='he_normal')(cat_4)
    conv_o1 = BatchNormalization()(conv_o1)
    conv_o2 = Conv2D(filters=32, kernel_size=(3,3), strides=(1,1),\
